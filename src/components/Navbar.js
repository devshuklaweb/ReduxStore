            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item"><Link className={`nav-link ${location.pathname === '/viewcart' ? 'active' : ''} `} aria-current="page" to="/viewcart">Cart</Link></li>      
                    </ul>
                    <div>
                        <button disabled={true} className="btn btn-primary">Cart Items: {items.length}</button>
                    </div>
                </div>
            </div>
        </nav>
